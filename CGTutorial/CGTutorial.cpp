...
//float rotationZ = 0;
//
//float rotationSegOne = 0;
//float rotationSegTwo = 0;
//float rotationSegThree = 0;
//float rotateCordinateSystem = 0;
//
//
...
//	case GLFW_KEY_B:
//		rotationSegOne += 5;
//		rotationSegOne = fmod(rotationSegOne, 360.0f);
//		break;
//	case GLFW_KEY_N:
//		rotationSegTwo += 5;
//		rotationSegTwo = fmod(rotationSegTwo, 360.0f);
//		break;
//	case GLFW_KEY_M:
//		rotationSegThree += 5;
//		rotationSegThree = fmod(rotationSegThree, 360.0f);
//		break;
//	case GLFW_KEY_V:
//		rotateCordinateSystem += 5;
//		rotateCordinateSystem = fmod(rotateCordinateSystem, 360.0f);
//		break;
//	default:
//		break;
//	}
...
//	glm::mat4 save = Model;
//
//	Model = glm::scale(Model, glm::vec3(10, 0.01, 0.01));
//	sendMVP();
//	drawCube();
//	Model = save;
//
//	Model = glm::scale(Model, glm::vec3(0.01, 10, 0.01));
//	sendMVP();
//	drawCube();
//	Model = save;
//
//	Model = glm::scale(Model, glm::vec3(0.01, 0.01, 10));
//	sendMVP();
//	drawCube();
//	Model = save;
//}
...
//	glDepthFunc( GL_LESS ); // @See: http://wiki.delphigl.com/index.php/glDepthFunc
//
...
//		glm::mat4 matrixSave = Model;
//
//		// important. Save Model matrix before doing any special actions for teapot, cube ....
//		// draw Teapot
//		Model = matrixSave;
//		Model = glm::scale(Model, glm::vec3(1.0 / 1000.0, 1.0 / 1000.0, 1.0 / 1000.0));
//		// Model = glm::scale(Model, glm::vec3(1.0 / 10.0, 1.0 / 10.0, 1.0 / 10.0));				
//
//		sendMVP();
//		glBindVertexArray(VertexArrayIDTeapot);
...
//		//drawWireCube();						
//		// drawCube();
//		Model = glm::rotate(Model, rotateCordinateSystem, glm::vec3(0,0,1));
//		Model = glm::rotate(Model, rotationSegOne, glm::vec3(1,0,0));
//		drawSegment(0.5);
//		Model = glm::translate(Model, glm::vec3(0.0, 0.5, 0.0));
//		Model = glm::rotate(Model, rotationSegTwo, glm::vec3(1,0,0));
//		drawSegment(0.4);		
//		Model = glm::translate(Model, glm::vec3(0.0, 0.4, 0.0));
//		Model = glm::rotate(Model, rotationSegThree, glm::vec3(1,0,0));
//		drawSegment(0.3);
